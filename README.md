...
[**Baixar DiSlackso para Windows**](https://github.com/spikeleez/dislackso/releases/latest/download/DiSlackso-Setup-3.3.1.exe) | [Versão Portátil (.zip)](https://github.com/spikeleez/dislackso/releases/latest/download/DiSlackso-portable-3.3.1.zip)
...
Gera `dist/DiSlackso-Setup-3.3.1.exe` (~79 MB). Instalador comum: escolhe pasta, cria atalho,
