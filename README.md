...
[**Baixar DiSlackso para Windows**](https://github.com/spikeleez/dislackso/releases/latest/download/DiSlackso-Setup-3.5.1.exe) | [Versão Portátil (.zip)](https://github.com/spikeleez/dislackso/releases/latest/download/DiSlackso-portable-3.5.1.zip) | [**Linux (.AppImage)**](https://github.com/spikeleez/dislackso/releases/latest/download/DiSlackso-3.5.1.AppImage) | [.rpm (Fedora e derivados)](https://github.com/spikeleez/dislackso/releases/latest/download/DiSlackso-3.5.1.rpm)
...
Gera `dist/DiSlackso-Setup-3.5.1.exe` (~79 MB). Instalador comum: escolhe pasta, cria atalho,
...
Gera `dist/DiSlackso-3.5.1.AppImage` e `dist/DiSlackso-3.5.1.rpm`. O `.rpm` instala nativo
